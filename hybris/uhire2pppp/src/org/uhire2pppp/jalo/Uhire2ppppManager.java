...
/**
 * This is the extension manager of the Uhire2pppp extension.
 */
public class Uhire2ppppManager extends GeneratedUhire2ppppManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(Uhire2ppppManager.class);
	 ...
	 */
	public static Uhire2ppppManager getInstance()
	{
		return (Uhire2ppppManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Uhire2ppppConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Uhire2ppppManager() // NOPMD 
	{
		LOG.debug("constructor of Uhire2ppppManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of Uhire2ppppManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of Uhire2ppppManager called, current tenant: {}", getTenant().getTenantID());
	}
