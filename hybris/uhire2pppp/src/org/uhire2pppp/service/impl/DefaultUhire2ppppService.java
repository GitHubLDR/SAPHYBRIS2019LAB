...
public class DefaultUhire2ppppService implements Uhire2ppppService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultUhire2ppppService.class);
	...
	{
		return DefaultUhire2ppppService.class.getResourceAsStream("/uhire2pppp/sap-hybris-platform.png");
	}
