...
public class DefaultUhire33pService implements Uhire33pService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultUhire33pService.class);
	...
	{
		return DefaultUhire33pService.class.getResourceAsStream("/uhire33p/sap-hybris-platform.png");
	}
