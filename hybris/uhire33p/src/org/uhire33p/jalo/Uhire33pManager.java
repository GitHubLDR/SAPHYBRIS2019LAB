...
/**
 * This is the extension manager of the Uhire33p extension.
 */
public class Uhire33pManager extends GeneratedUhire33pManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(Uhire33pManager.class);
	 ...
	 */
	public static Uhire33pManager getInstance()
	{
		return (Uhire33pManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Uhire33pConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Uhire33pManager() // NOPMD 
	{
		LOG.debug("constructor of Uhire33pManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of Uhire33pManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of Uhire33pManager called, current tenant: {}", getTenant().getTenantID());
	}
