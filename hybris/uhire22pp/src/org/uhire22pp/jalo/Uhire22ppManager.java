...
/**
 * This is the extension manager of the Uhire22pp extension.
 */
public class Uhire22ppManager extends GeneratedUhire22ppManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(Uhire22ppManager.class);
	 ...
	 */
	public static Uhire22ppManager getInstance()
	{
		return (Uhire22ppManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Uhire22ppConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Uhire22ppManager() // NOPMD 
	{
		LOG.debug("constructor of Uhire22ppManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of Uhire22ppManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of Uhire22ppManager called, current tenant: {}", getTenant().getTenantID());
	}
