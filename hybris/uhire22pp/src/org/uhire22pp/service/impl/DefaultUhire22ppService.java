...
public class DefaultUhire22ppService implements Uhire22ppService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultUhire22ppService.class);
	...
	{
		return DefaultUhire22ppService.class.getResourceAsStream("/uhire22pp/sap-hybris-platform.png");
	}
