...
/**
 * This is the extension manager of the Uhire2s extension.
 */
public class Uhire2sManager extends GeneratedUhire2sManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(Uhire2sManager.class);
	 ...
	 */
	public static Uhire2sManager getInstance()
	{
		return (Uhire2sManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Uhire2sConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public Uhire2sManager() // NOPMD 
	{
		LOG.debug("constructor of Uhire2sManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of Uhire2sManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of Uhire2sManager called, current tenant: {}", getTenant().getTenantID());
	}
