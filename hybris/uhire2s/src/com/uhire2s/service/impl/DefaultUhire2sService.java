...
public class DefaultUhire2sService implements Uhire2sService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultUhire2sService.class);
	...
	{
		return DefaultUhire2sService.class.getResourceAsStream("/uhire2s/sap-hybris-platform.png");
	}
