...
public class DefaultUhirenewService implements UhirenewService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultUhirenewService.class);
	...
	{
		return DefaultUhirenewService.class.getResourceAsStream("/uhirenew/sap-hybris-platform.png");
	}
