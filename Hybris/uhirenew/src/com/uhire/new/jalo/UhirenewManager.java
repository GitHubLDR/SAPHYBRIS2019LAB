...
/**
 * This is the extension manager of the Uhirenew extension.
 */
public class UhirenewManager extends GeneratedUhirenewManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(UhirenewManager.class);
	 ...
	 */
	public static UhirenewManager getInstance()
	{
		return (UhirenewManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(UhirenewConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public UhirenewManager() // NOPMD 
	{
		LOG.debug("constructor of UhirenewManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of UhirenewManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of UhirenewManager called, current tenant: {}", getTenant().getTenantID());
	}
