...
import org.harish.test.constants.HarishTestConstants;
import org.harish.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = HarishTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/harishtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/harishtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/harishtest/import/cstickets.impex");
			...
			importImpexFile(context, "/harishtest/import/csquotes.impex");
		}
	}
}
