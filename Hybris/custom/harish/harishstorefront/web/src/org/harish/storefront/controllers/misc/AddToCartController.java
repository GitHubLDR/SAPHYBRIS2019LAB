 ...
 */
package org.harish.storefront.controllers.misc;
...
import org.harish.storefront.controllers.ControllerConstants;
...
public class AddToCartController extends AbstractController
{
	...
	private static final String SHOWN_PRODUCT_COUNT = "harishstorefront.storefront.minicart.shownProductCount";
	...
	public final String addQuickOrderToCart(@RequestBody final AddToCartOrderForm form, final Model model)
	{
		...
		final int maxQuickOrderEntries = Config.getInt("harishstorefront.quick.order.rows.max", 25);
