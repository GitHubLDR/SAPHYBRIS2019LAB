...
/**
 * Generated class for type {@link org.harish.core.jalo.ApparelStyleVariantProduct ApparelStyleVariantProduct}.
 */
...
public abstract class GeneratedApparelStyleVariantProduct extends VariantProduct
{
	...
	/** Qualifier of the <code>ApparelStyleVariantProduct.myText</code> attribute **/
	...
	static
	{
		...
		tmp.put(MYTEXT, AttributeMode.INITIAL);
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>ApparelStyleVariantProduct.myText</code> attribute.
	 * @return the myText
	 */
	public String getMyText(final SessionContext ctx)
	{
		if( ctx == null || ctx.getLanguage() == null )
		{
			throw new JaloInvalidParameterException("GeneratedApparelStyleVariantProduct.getMyText requires a session language", 0 );
		}
		return (String)getLocalizedProperty( ctx, MYTEXT);
	}
	...
	{
		return getMyText( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Getter of the <code>ApparelStyleVariantProduct.myText</code> attribute. 
	 * @return the localized myText
	 */
	public Map<Language,String> getAllMyText(final SessionContext ctx)
	{
		return (Map<Language,String>)getAllLocalizedProperties(ctx,MYTEXT,C2LManager.getInstance().getAllLanguages());
	}
	 ...
	 * @return the localized myText
	 */
	public Map<Language,String> getAllMyText()
	{
		return getAllMyText( getSession().getSessionContext() );
	}
	
	/**
	 * <i>Generated method</i> - Setter of the <code>ApparelStyleVariantProduct.myText</code> attribute. 
	 * @param value the myText
	 */
	public void setMyText(final SessionContext ctx, final String value)
	{
		if ( ctx == null) 
		{
		...
		{
			throw new JaloInvalidParameterException("GeneratedApparelStyleVariantProduct.setMyText requires a session language", 0 );
		}
		setLocalizedProperty(ctx, MYTEXT,value);
	}
	 ...
	 * @param value the myText
	 */
	public void setMyText(final String value)
	{
		setMyText( getSession().getSessionContext(), value );
	}
	 ...
	 * @param value the myText
	 */
	public void setAllMyText(final SessionContext ctx, final Map<Language,String> value)
	{
		setAllLocalizedProperties(ctx,MYTEXT,value);
	}
	 ...
	 * @param value the myText
	 */
	public void setAllMyText(final Map<Language,String> value)
	{
		setAllMyText( getSession().getSessionContext(), value );
	}
