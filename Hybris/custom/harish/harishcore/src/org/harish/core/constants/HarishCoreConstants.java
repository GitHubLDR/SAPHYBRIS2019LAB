...
/**
 * Global class for all HarishCore constants. You can add global constants for your extension into this class.
 */
public final class HarishCoreConstants extends GeneratedHarishCoreConstants
{
	public static final String EXTENSIONNAME = "harishcore";


	private HarishCoreConstants()
	{
		//empty
	}
