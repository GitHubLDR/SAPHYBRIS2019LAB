 ...
 */
package org.harish.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(HarishFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(HarishFulfilmentProcessConstants.PARENT_PROCESS);
