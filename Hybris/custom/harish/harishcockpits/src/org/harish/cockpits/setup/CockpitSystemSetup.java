 ...
 */
package org.harish.cockpits.setup;
...
import org.harish.cockpits.constants.HarishCockpitsConstants;
 ...
 */
@SystemSetup(extension = HarishCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(HarishCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(HarishCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						HarishCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/harishcockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
