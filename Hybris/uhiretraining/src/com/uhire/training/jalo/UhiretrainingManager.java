 ...
 */
package com.uhire.training.jalo;
...
/**
 * This is the extension manager of the Uhiretraining extension.
 */
public class UhiretrainingManager extends GeneratedUhiretrainingManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(UhiretrainingManager.class);
	 ...
	 */
	public static UhiretrainingManager getInstance()
	{
		return (UhiretrainingManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(UhiretrainingConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public UhiretrainingManager() // NOPMD 
	{
		LOG.debug("constructor of UhiretrainingManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of UhiretrainingManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of UhiretrainingManager called, current tenant: {}", getTenant().getTenantID());
	}
