...
public class DefaultUhiretrainingService implements UhiretrainingService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultUhiretrainingService.class);
	...
	{
		return DefaultUhiretrainingService.class.getResourceAsStream("/uhiretraining/sap-hybris-platform.png");
	}
