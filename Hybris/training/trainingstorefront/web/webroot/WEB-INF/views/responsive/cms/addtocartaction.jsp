...
<form:form  id="addToCartForm" method="post" class="add_to_cart_form" action="/cart">
...
<input type="hidden" name="productCodePost" value="${fn:escapeXml(product.code)}"/>
				...
				<button  type="submit" class="btn btn-primary btn-block js-add-to-cart js-enable-btn btn-icon glyphicon-shopping-cart" disabled="disabled" >
					<spring:theme code="Add to Wishlist"/>
				</button>
