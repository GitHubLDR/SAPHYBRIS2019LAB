...
<form:form method="post" commandName="registerForm" action="${action}">
	...
	<formElement:formInputBox idKey="register.lastName"
		...
		mandatory="true" />
		<formElement:formInputBox idKey="Phone"
		labelKey="Phone Number" path="mobileNumber" inputCSS="form-control"
		mandatory="true" />
                    ...
                    <div class="form-element-icon datepicker quote__expiration" id="js-quote-expiration-time"
                        ...
                        <formElement:formInputBox idKey="expirationTime"
                                                  labelKey="text.quote.expiration.time.label" path="dateOfBirth"
